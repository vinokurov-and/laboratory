...
4. [Изучение `useEffect` и имитация асинхронных запросов в React](https://github.com/vinokurov-and/laboratory/blob/main/programming-language/javascript/react/3.%useEffect-app.md)
